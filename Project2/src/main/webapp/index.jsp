                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Puppy Sweeties</b> Shop</h1>
                                <h3 class="h2">We Care about your Puppies</h3>
                                <p>
                                    Puppy Sweeties Shop is a online shop for your puppies and we also support delivery services for your shop.
                                    You can surf in our shop as your desire products by clicking shop menu. You can make your payment by banking or in cash.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                <h1 class="h1">CUTE GIRL DOG ACCESSORIES</h1>
                                <h3 class="h2">Girl Dog Collar</h3>
                                <p>
                                    Cute Dog Collars for Every Kind of Cute dog .Best Useful and Louis vuitton dog choker.
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                <h1 class="h1">Coming Event</h1>
                                <h3 class="h2">Special Promotions for Every Event</h3>
                                <p>
                                    We bring you special promotions for your puppies. 
                                    If you wish to support your puppy, please make a love by buying pet products. Thank you.
                                </p>
                            </div>
                        </div>
                    </div>
