                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./assets/img/admin.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Welcome Admin</b></h1>
                                <h3 class="h2">Actions of Admin</h3>
                                <p>
                                    In admin page, you can add or remove pet products. And you can add other admin accounts who can adminstrate this page.
                                </p>
                            </div>
                        </div>
                    </div>
