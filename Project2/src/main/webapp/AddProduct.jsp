   ...
   <div class="container">
    <form action="product" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="productName" name="productName" placeholder="Enter Product Name" class="form-control" required="required" autofocus>
        </div>
         <div class="mb-3">
            <label for="qty" class="form-label">*Quantity</label>
            <input type="number" id="qty" name="qty" placeholder="Enter Quantity" class="form-control" required="required" autofocus>
        </div>
         <div class="mb-3">
            <label for="description" class="form-label">*Description</label>
            <textarea id="description" name="description" placeholder="Enter Description" class="form-control" required="required" autofocus></textarea>
        </div>
         <div class="mb-3">
            <label for="sellingprice" class="form-label">*Selling Price</label>
            <input type="number" id="sellingprice" name="sellingprice" placeholder="Enter Selling Price" class="form-control" required="required" autofocus>
        </div>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="text" id="brandName" name="brandName" placeholder="Enter Brand Name" class="form-control" required="required" autofocus>
        </div>
