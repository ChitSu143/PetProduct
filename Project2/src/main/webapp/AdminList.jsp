...
<body>
 ...
 <!-- Header -->
   ...
   <br>
        <h2 class="mb-3 text-center">Admin List</h2>
		...
		<table id="result" class="table table-striped" style="color: green;">
			<thead>
				<tr>
					...
					<th>Password</th>
					<th>Role</th>
					<th><a href="AdminSignUp.jsp" class="btn btn-primary">Create Admin Account</a></th>
			...
			<tfoot>
				<tr>
					...
					<th>Password</th>
					<th>Role</th>
					<th><a href="AdminSignUp.jsp" class="btn btn-primary">Create New Admin Account</a></th>
