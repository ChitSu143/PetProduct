...
<body>
   ...
   <div class="container">
    <form action="PetController" method="get" name="mode" value="UPDATE" "form-horizontal" role="form">
    
    <br>
        <h2 class="mb-3 text-center" style="color:green">Update Member Information</h2>
        ...
        <div class="mb-3">
            ...
            <input type="text" value="${pet.petName}" id="petName" name="petName" placeholder="Enter Your Pet Name" class="form-control" required="required" autofocus>
        </div>
        
        <div class="mb-3">
            <label for="petAge" class="form-label">*Pet Age</label>
            <input type="number" value="${pet.petAge}" id="petAge" name="petAge" placeholder="Enter Your Pet Age" class="form-control" required="required" autofocus>
        </div>
        
        <div class="mb-3">
            <label for="ownerName" class="form-label">*Owner Name</label>
            <input type="text" value="${pet.ownerName}" id="ownerName" name="ownerName" placeholder="Enter Your Owner Name" class="form-control" required="required" autofocus>
        </div>
